...
mkdir -p target_regions_analysis_230911

export R_LIBS_USER="~/R-modules:$R_LIBS_USER"

R-3.6.1 --version

R-3.6.1 --slave -f $scriptsfolder/target_regions_analysis_230911.r --args $manifest \
                                                                          ...
                                                                          $ncores \
                                                                          > target_regions_analysis_230911/target_regions_analysis.log 2>&1
